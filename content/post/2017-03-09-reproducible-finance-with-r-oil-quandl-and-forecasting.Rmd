...
date: '2017-03-09'
categories: [R Views]
tags: [Reproducible Finance with R, R Language, Data Science]
draft: yes
summary: 'A Notebook for importing oil prices from Quandl, making a 6 months forecast and visualizig the results'
---
...
Now, let's get to the data download! In the chunk below, as we import WTI oil prices, notice that Quanld makes it easy to choose types of objects (raw/dataframe or xts or zoo), periods (daily, weekly, monthly) and start/end dates.   
