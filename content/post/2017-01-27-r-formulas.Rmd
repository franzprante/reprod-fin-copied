 ...
 * the `Petal.Length` has been logged and the column name is not a valid name, and
...
In a future post, I will discuss some limitations of the standard formula interface.
