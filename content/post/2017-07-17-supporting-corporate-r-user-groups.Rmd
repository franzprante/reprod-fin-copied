...
At RStudio, I have the pleasure of interacting with data science teams around the world. Many of these teams are led by R users stepping into the role of [analytic admins](https://rviews.rstudio.com/2017/06/21/analytics-administration-for-r/). These users are responsible for supporting and growing the R user base in their organization and often lead internal R user groups. 

One of the most successful strategies to support a corporate R user group is the creation of an internal R package. This article outlines some common features and functions shared in internal packages. Creating an R package is easier than you might expect. A good place to start is this [webinar on package creation](https://www.rstudio.com/resources/webinars/rstudio-essentials-webinar-series-programming-part-3/).
...
Once available, logos and CSS can be added to [Shiny apps](https://shiny.rstudio.com/articles/css.html) and [R Markdown documents](http://rmarkdown.rstudio.com/html_document_format.html#custom_css).
...
ggplot2 themes are shared as functions. To get started writing a ggplot2 theme, see [resource 1](http://ggplot2.tidyverse.org/reference/theme.html). For inspiration, take a look at the [ggthemes package](https://cran.r-project.org/web/packages/ggthemes/vignettes/ggthemes.html).
...
If you’re not sure where to begin, look through your own scripts for common database connection strings or configurations. [db.rstudio.com](https://db.rstudio.com) can provide more information on how to handle credentials, drivers, and config files.

## learnr Tutorials

RStudio recently released a new package for creating interactive tutorials in R Markdown called [learnr](https://rstudio.github.io/learnr/). There are many great resources online for getting started with R, but it can be useful to create tutorials specific to your internal data and domain. learnr tutorials can serve as training wheels for the other components of the internal R package or teach broader concepts and standards accepted across the organization. For example, you might provide a primer that teaches new users your organization’s R style guide.

![](/post/2017-07-17-corporate-r-user-groups/learnr_example.gif)
