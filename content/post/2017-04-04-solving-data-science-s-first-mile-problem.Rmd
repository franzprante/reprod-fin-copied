...
One group that is using data.world to effectively solve their first mile problem is [Data for Democracy](http://datafordemocracy.org/).  This incredibly diverse group of over 1200 people aim “to be an inclusive community for data scientists and technologists to volunteer and collaborate on projects that make a positive impact on society”.  The [Medicare/Medicaid drug spending project](https://data.world/data4democracy/drug-spending) makes particularly great use of the unique features of data.world datasets by including files of many different formats, [publishing queries](https://data.world/data4democracy/drug-spending/query/94dfc980-5bb7-4190-8696-a40a6e724bfb), and then [building dashboards](https://jenniferthompson.shinyapps.io/shinydashboard-medicared/) using Shiny against the normalized data queried from our [API](https://docs.data.world/documentation/api/). Now their first mile work is captured in an accessible format with clear context, so others will be able to easily and quickly build off of it in the future.

```
Figure goes here
``` 
Context is king in so many aspects of life, and it’s especially true when you’re working with data. There are so many things that you can do with data.  In order to accomplish these things, you need to build an understanding of the data that you’re working with.  data.world datasets provide that context by getting you to the who, what, where, when, why and how of the data, fast.  Once you understand that data, we want you to get that data into your tools as quickly as possible with our [APIs and SDKs](https://docs.data.world/), and then get any analysis you’ve done back into data.world for further distribution and discussion.
