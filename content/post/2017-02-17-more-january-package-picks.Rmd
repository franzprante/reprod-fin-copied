...
In a recent post, I highlighted several new package that arrived on CRAN in January that provided R users access to data. In this post, I present additional selections for interesting January packages organized into the categories Miscellaneous, Machine Learning, Statistics and Utilities.
...
* [manipulateWidget](https://cran.rstudio.com/web/packages/manipulateWidget/) v0.5.1: Provides helper functions to add controls like sliders, pickers, checkboxes, etc. to interactive chartc created with package [htmlwidgets](https://cran.r-project.org/web/packages/htmlwidgets/index.html). The animated [vignette](https://cran.rstudio.com/web/packages/manipulateWidget/vignettes/manipulateWidgets.html) will get you started.
...
* [padr](https://cran.rstudio.com/web/packages/padr/) v0.2.0: Provides functions to ransform datetime data into a format ready for analysis. including aggregating data to a higher level interval (thicken) and imputing records where observations were absent (pad). There is a [Introduction](https://cran.rstudio.com/web/packages/padr/vignettes/padr.html).

* [pbdPRC](https://cran.rstudio.com/web/packages/pbdRPC/) v0.1-1: Implements light, yet secure remote procedure calls with unified interface via ssh (OpenSSH) or plink/plink.exe (PuTTY). The [vignette](https://cran.rstudio.com/web/packages/pbdRPC/vignettes/pbdRPC-guide.pdf) provides examples.

* [reprex](https://cran.rstudio.com/web/packages/reprex/) v0.1.1: Provides a way to send code snippets with rendered output to sites like [stackoverflow](http://stackoverflow.com) and [github](https://github.com). [README](https://cran.rstudio.com/web/packages/reprex/README.html) shows examples.

* [restfulr](https://cran.rstudio.com/web/packages/restfulr/) v0.0.8: Models a RESTful service as if it were a list.

* [sys](cran.rstudio.com/web/packages/sys/) v1.1: A replacement base [system2](http://stat.ethz.ch/R-manual/R-devel/library/base/html/system2.html) with consistent behavior across platforms. Supports interruption, background tasks, and full control over STDOUT / STDERR binary or text streams. [README](https://github.com/jeroenooms/sys#readme) provides some details.

* [textclean](https://cran.rstudio.com/web/packages/textclean/) v0.3.0: Provides tools to clean and process text such as replacing or removing substreams that are not optimal for analysis.[README](https://cran.rstudio.com/web/packages/textclean/README.html) shows how to use them.
...
* [unpivotr](https://cran.rstudio.com/web/packages/unpivotr/) v0.1.0: Provides tools for converting data from complex or irregular layouts into a columnar structure. There is a [vignette](https://cran.rstudio.com/web/packages/unpivotr/vignettes/compass-directions.html) showing how to unpivot pivot tables from a spreadsheet and [another](https://cran.rstudio.com/web/packages/unpivotr/vignettes/small-multiples.html) that shows how to work with multiple, similar tables.
