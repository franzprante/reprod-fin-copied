...
RStudio automatically indexes all open files as well as files in the current project. The index includes function calls and objects within the files. To search the index, enter a search string in the `Go to file/function` window in the main toolbar or use the keyboard shortcut `Ctrl + .`. 
...
![](/post/2017-03-24-march-17-tips-and-tricks_files/go_to_file.png)
...
The other options, `To Project Directory` and `To File Pane Location` are also very helpful. These commands do not have key bindings by default, but you can create your own keyboard shortcuts for these actions: `Tools -> Modify Keyboard Shortcuts...`
...
Be sure to follow [\@rstudiotips](https://twitter.com/rstudiotips) for more frequent updates. Tweet us [\@rstudio](https://twitter.com/rstudio) if there's a file navigation trick you wish we'd implement! 
